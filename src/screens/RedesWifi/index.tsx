...
type NetworkInfo = {
  type: Network.NetworkStateType; // ENUM: Wifi | Celular
  isConnected: boolean;
      ...
      <View style={styles.content}>
        ...
        {loading && !info ? (
          <View style={styles.loadingBox}>
            <ActivityIndicator size="large" color="#811fac"></ActivityIndicator>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>
                  {isWifi ? "Conectado por Wi-Fi" : "Não conectado por Wi-Fi"}
                </Text>
              </View>

              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>Endereço de IP</Text>
                <Text style={styles.infoValue}>{info.ipAddress}</Text>
              </View>

              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>Status modo avião</Text>
          ...
          {/* Card informativo sobre limitações do Expo Go para varredura de redes */}
            ...
            <TouchableOpacity style={styles.refreshButton} onPress={carregarRede} activeOpacity={0.85} disabled={loading}>
